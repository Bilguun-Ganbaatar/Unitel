...
const features = [
  ...
  },
  {
    ...
    description: (
      <>
        Оршин суугчдын дундын чат <br /> Building-ийн зар мэдээ <br /> Төлбөр төлөх, шалгах <br />{" "}
        СӨХ-тэй шууд холбогдох
      </>
    ),
    imgLeft: true,
  },
  {
    ...
    description: (
      <>
        ...
        авалт хийх <br /> Санхүү, тайлан харах <br /> Оршин суугчдын мэдээлэл удирдах
      </>
    ),
    imgLeft: false,
  },
  {
    title: "Built for Modern Buildings",
    description: (
      <>
        Орон сууцны хотхон <br /> Оффис барилга <br /> Худалдааны төв <br /> Олон блок бүхий
        комплекс <br /> бүгдэд тохирно.
      </>
    ),
    imgLeft: true,
  },
